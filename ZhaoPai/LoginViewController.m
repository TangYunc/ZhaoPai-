...
- (void)loginButtonAction:(UIButton *)button{
    ...
    //配置参数
        ...
        //拼接URL
        NSString *urlString = [@"http://192.168.88.23:83/" stringByAppendingString:@"CheckUser?"];
        ...
        [manager POST:String parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
            ...
            if (responseObject[@"UserName"] == _accountNameTF.text && responseObject[@"Password"] == _passwordTF.text ) {
