...
//密码需要6-20位数字或字母
            ...
            NSString *VerificationUrlString = [@"http://192.168.88.23:83/" stringByAppendingString:userString];
            ...
            [manager GET:VerificationUrlString parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
                ...
                if ([operation.responseString isEqualToString:@"false"]) {
                    ...
                    //该账户名没有注册，现在可以进行注册
                    //配置参数
                    NSString *url = [@"http://192.168.88.23:83/" stringByAppendingString:@"api/UserAccounts"];
